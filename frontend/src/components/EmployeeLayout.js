...
//     { label: 'Fetch Products', path: '/product-fetch', icon: <FaUpload /> },
//     { label: 'Profile', path: '/profile', icon: <FaUserCircle /> },
//     { label: 'Manage Employee', path: '/employee', icon: <FaUsers /> },
//     { label: 'Approve Products', path: '/approve', icon: <FaUserCheck /> },
...
//   navSection: {
//     flex: 1,
//     padding: '24px 0 16px 0' // Add bottom space
//   },
//   navList: {
//     listStyle: 'none',
//     padding: 0,
